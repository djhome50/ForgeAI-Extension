...
import { TaskBoardView } from "./components/task-board"
import { useAddNonInteractiveClickListener } from "./components/ui/hooks/useNonInteractiveClick"
import { TooltipProvider } from "./components/ui/tooltip"
import { STANDARD_TOOLTIP_DELAY } from "./components/ui/standard-tooltip"

type Tab = "settings" | "history" | "chat" | "marketplace" | "cloud" | "tasks"
...
const App = () => {
	...
	return showWelcome ? (
		...
		<>
			...
			{tab === "tasks" && <TaskBoardView onDone={() => switchTab("chat")} />}
			<ChatView
				ref={chatViewRef}
				isHidden={tab !== "chat"}
